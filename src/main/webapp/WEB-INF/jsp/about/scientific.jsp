	...
	<section class="main-body">
		<div class="container-fluid about-banner-header parallax">
			...
			<div class="container text-center">
				<h2>科学体系</h2>
				<p class="intro">运用专业的技术，为儿童提供正规而完整的运动发育评估与训练方案。</p>
				<div class="text-center">
					<ul class="nav nav-pills nav-about">
						<li role="presentation" ><a href="../home/us.do">关于我们</a></li>
	                    <li role="presentation"class="active"><a href="javascript:;">科学体系</a></li> 
		...
		<div class="container about-content">
			<h2>科学体系</h2>
			<p>奕贝儿童成长馆是北京体育大学产学研产业基地科研转化项目。将科研和实践紧密结合，拥有最优质完整的儿童运动健康管理体系。</p>
			<p>资源丰富优越，整合清华、北京体育大学的资源，多学科融合，运动人体，运动训练，体育教育，体育管理，运动心理专业的大融合。</p>
			<p>我们通过测试、评估、体能课程、营养干预、居家指导各种方法提高儿童体质健康水平。为您提供正规而完整的运动发育评估与训练方案。</p>
		</div>
		<div style="padding-left: 10%">
			<img alt="scientific" src="../static/images/scientific.png">
		</div>
	</section>
	<!-- <footer id="footer">
		<div class="container">
