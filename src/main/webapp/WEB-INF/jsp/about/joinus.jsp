...
<section class="main-body">
    <div class="container-fluid about-banner-header parallax">
        ...
        <div class="container text-center">
            <h2>加入我们</h2>
            <p class="intro">启承运动文化，高薪诚聘课程老师、销售精英，请发简历到我们的邮箱：76505735@qq.com</p>
            <div class="text-center">
                <ul class="nav nav-pills nav-about">
                    ...
                    <li role="presentation" ><a href="../home/scientific.do">科学体系</a></li>
                     <li role="presentation"><a href="../home/partners.do">合作伙伴</a></li>  <!-- ../home/partners.do" -->
                    <li role="presentation" ><a href="../home/contactus.do">联系我们</a></li>
                     <li role="presentation" class="active"><a href="javascript:;">加入我们</a></li>
                </ul>
            </div>
        </div>
    </div>
    <div class="contact-us-content">
        <div class="container about-content ">
            <h2>加入我们</h2>
            <h4>由于公司发展，我们欢迎课程老师和销售精英加入我们的团队，具体要求如下：</h4>
          	<h4><i class="uicon-map"></i>&nbsp;课程老师</h4>
            <ol class="contact-list">
				<li>1.对待小朋友要有爱心、有责任心、有耐心。</li>
				<li>2.喜爱孩子，良好的与小朋友沟通交流的能力。</li>
				<li>3.体育专业背景，优先考虑体操、健美操、跆拳道等专项。</li>
				<li>4.高效的学习能力，为自己将来能胜任管理岗位而不断学习。</li>
				<li>5.有幼儿体育教学经验者优先考虑。</li>
            </ol>
            <h4><i class="uicon-map"></i>&nbsp;销售精英</h4>
            <ol class="contact-list">
				<li>1.男女不限,热爱运动。</li>
				<li>2.良好的执行能力和沟通能力。</li>
				<li>3.强烈的成功欲，敢于挑战高薪。</li>
				<li>4.有相关经验者优先考虑。</li>
            </ol>
            <h4>我们求贤若渴，只要有实力和责任心，我们将非常欢迎你的加入，报酬优厚！</h4>
            <ol class="contact-list">
                <li><b>腾讯&nbsp;QQ：</b>76505735</li>
