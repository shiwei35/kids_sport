...
<body
	class="page page-id-0 page-parent page-template-default body-ui-cookies">
			...
			<div class="header-main">
				...
				<div class="container header-wrap">
					<div class="navbar-header">
						...
						<a href="../index.htm" tppabs="http://www.uiessays.com/"
							title="优易论文"> <img alt="优易论文"
							src="../wp-content/uploads/2016/01/11.png"
		...
		<div id="login" style="display: none">
			<div class="login-box">
				<div class="window_logo">
					<img src="../../cdn.uiessays.com/static/images/logo_window.png"
					...
					<div class="col-md-12">
						...
						<div class="login-model">
							...
							<div class="login-additional">
								<div class="lost">
									<a href="../wp-login.php-action=lostpassword.htm"
					...
					<div class="col-md-12">
						...
						<div class="input-group top20 text-center reg-group">
							<input type="hidden" id="security" name="security"
								...
								type="hidden">
							<button class="btn btn-success submit" type="submit">注
								册</button>
	...
	<section class="main-body">
		<div class="container-fluid about-banner-header parallax">
			...
			<div class="container text-center">
				<h2>合作伙伴</h2>
				<p class="intro">我们和郑州贝体文化传播有限公司达成战略合作关系。</p>
				<div class="text-center">
					<ul class="nav nav-pills nav-about">
	                    ...
	                    <li role="presentation"><a href="../home/scientific.do">科学体系</a></li>
	                     <li role="presentation"class="active"><a href="javascript:;">合作伙伴</a></li>  <!-- ../home/partners.do" -->
		...
		<div class="container about-content">
			<h2>合作伙伴</h2>
			<p>郑州贝体文化传播有限公司是一家来自北京体育大学的创业型公司，核心团队均来自北京体育大学，专注少儿运动与健康。</p>
			<p>公司以3至12岁体质体能教学培训及体质健康检测管理课程为主要业务，兼有幼儿园体能课程开发与指导、体育赛事承办、假期夏令营、短期游泳、篮球集中训练营等专业培训，致力于改善儿童健康现状，提高儿童体质、体能水平及培养运动兴趣，目标是打造国内一流综合性少儿体育培训品牌。　</p>
			<p>该公司目前已经发展20家店面，店面分布郑州、杭州、广州、深圳等多地。</p>
		</div>
		<div style="text-align: center">
			<img alt="partners" src="../static/images/partners.jpg">
		</div>
	</section>
	<!-- <footer id="footer">
		<div class="container">
