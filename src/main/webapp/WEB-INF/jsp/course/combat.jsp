	...
	<section class="main-body">
		<div class="container-fluid about-banner-header parallax">
			...
			<div class="container text-center">
				<h1>少儿综合格斗</h1>
				<p class="intro">集合少儿武术、少儿柔道、少儿防身术、少儿拳击的内容及综合体能与礼仪等课程内容，防身强体，学会自卫。</p>
				<div class="text-center">
					<ul class="nav nav-pills nav-about">
						<li role="presentation"><a href="<%=request.getContextPath()%>/course/physical.do">幼儿体能课程</a></li>
						<li role="presentation" class="active"><a href="javascript:;">少儿综合格斗</a></li>
		...
		<div class="container about-content ">
			<h2>少儿综合格斗</h2>
			<p>4岁以后，孩子身体的协调性和柔韧性等能力发展较快，注意力、记忆力、思维能力、行为控制能力都有明显的提高，这已经为学习综合格斗提供了良好的条件。不少家长选择让孩子综合格斗不仅是为了提高孩子的自我防护能力，增强体质，少得病。</p>
			<p>更是为了能够促进孩子身体全面发育，培养正确的身体姿势，提高速度，协调，灵敏，力量，柔韧等素质。发展时空知觉和节奏知觉以及肌肉控制能力，想象力，注意力，形象和运动记忆力，模仿能力。培养尊师爱友，团结互助，勤学苦练，自律守规，自信自尊，勇敢坚毅等民族传统武德。</p>
		
		<div>
			<img alt="gedou" src="<%=request.getContextPath()%>/static/images/course/combat.png">
		</div>
</div>
		<div class="container about-content ">
