	...
	<section class="main-body">
		<div class="container-fluid about-banner-header parallax">
			...
			<div class="container text-center">
				<h1>动感啦啦操</h1>
				<p class="intro">包括少儿健身操基础，大众少儿一级健美操、少儿动感啦啦操、音乐律动操等，提升协调性，培养节奏与韵律。</p>
				<div class="text-center">
					<ul class="nav nav-pills nav-about">
						...
						<li role="presentation" class="active"><a href="javascript:;">动感啦啦操</a></li>
		...
		<div class="container about-content ">
			<h2>动感啦啦操</h2>
			<p>啦啦操是体育运动中的一个新兴项目，起源于美国，遍布美国的NBA、橄榄球、棒球、游泳、田径、摔角等比赛现场，至今已经有100多年的历史。最初为美式足球呐喊助威的活动发展，到现在成为世界范围内的一项体育运动。受到全世界人民的喜爱。</p>
			<p>通过啦啦操的学习，对儿童心肺功能，协调性，平衡性都有明显提高，增进他们的运动技能，培养儿童们的团队意识，增强大家相互协作的能力，提高儿童之间的责任心和责任感，增进队员之间的信任感，以及队员们的服从能力和克服一切困难，完成任务的坚强的毅力等。</p>
		
		<div>
			<img alt="lalcao" src="<%=request.getContextPath()%>/static/images/course/lalcao.png">
		</div>
</div>
		<div class="container about-content ">
