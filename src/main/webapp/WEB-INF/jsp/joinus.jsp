...
<link rel='stylesheet' id='pagecss-css'  href="../wp-content/themes/Essays/css/page.css"  type='text/css' media='all' />
...
<![endif]-->
	...
	<body class="page page-id-2693 page-template-default" >
				...
				<div id="navbar" class="collapse navbar-collapse">
						<div id="main-nav" class="menu-header%e8%8f%9c%e5%8d%95-container">
							<ul id="menu-header%e8%8f%9c%e5%8d%95" class="nav navbar-nav">
								<li class="current-menu-item"><a href="../index.do">首页</a></li>
								...
								<li class="online-order"><a href="order-now.jsp">关于我们</a>
									<ul class="sub-menu">
										...
										<li><a href="../home/us.do">联系我们</a></li>
			...
			<form name="signupform" id="signupform" action="http://www.uiessays.com/wp-login.php" class="hidden"  method="post" novalidate="novalidate">
				<div class="col-md-12">
					...
					<div class="agree-tos-pp">
						点击注册即表明你同意本 <a href="about/tos.htm" tppabs="http://www.uiessays.com/about/tos"  target="_blank">服务条款</a> 和 <a href="about/privacy_policy.htm" tppabs="http://www.uiessays.com/about/privacy_policy"  target="_blank">隐私条款</a>。
					</div>
...
<div id="wrap" class="ui-page">
	<div class="n post-content">
     	<div class="n">
     		<div class="topbn" style="background: url('http://www.uiessays.com/wp-content/uploads/2014/11/bg-servicepage-banner.jpg') no-repeat scroll center 0px #08B9EF;">
<h1>加入我们</h1>
<p>奕贝儿童健康成长馆，高薪诚聘课程老师、销售精英，请发简历到我们的邮箱：76505735@qq.com</p>
</div>
<div class="pagestyle">
<div class="container">
<p>由于公司发展，我们欢迎课程老师和销售精英加入我们的团队，具体要求如下：</p>
<ol>
<li>男女不限；</li>
<li>热爱运动；</li>
<li>良好的沟通能力和执行能力；</li>
...
<p>&nbsp;</p>
<p>&nbsp;</p>
<p>我们求贤若渴，只要有实力和责任心，我们将非常欢迎你的加入，报酬优厚！</p>
		...
		<div class="container">
			<div class="footleft col-xs-12 col-md-10">
				<div class="col-xs-12 col-md-5 text-left">
					<h3 class="ui-logo-text hide-text">启承体育文化</h3>
					<p class="hidden-xs">
