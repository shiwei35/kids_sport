	...
	<section class="main-body">
		<div class="container-fluid order-header parallax">
			...
			<div class="container">
				<div class="col-xs-12 col-md-2 l-sidebar">
					<img src="../static/images/icon/Writing.png" alt="论文写作服务">
				</div>
				<div class="col-xs-12 col-md-8 order-intro">
					<h1>儿童体能测评</h1>
					<p>通过测试、评估、体能课程、营养干预、居家指导各种方法提高儿童体质健康水平。</p>
					<div class="tags">
						<span class="i-tag">运动发育检测</span> <span class="i-tag">专业体能检测</span>
						<span class="i-tag">专业运动素质监控</span>
					</div>
				</div>
		...
		<div class="container order-now">
			<div id="orderwarp"
				...
				<form method="POST" role="form" class="order-form"
					name="order-form"	id="order-form">
					<div id="form-content">
						<fieldset id="one" class="col-md-12">
							...
							<ul id="userPanel"
								...
								<li>
									<div class="col-md-3">
										<label for="order_item"> * 选择测评</label>
									</div>
									<div class="col-md-6">
										<select id="order_item" name="order_item"
											class="form-control required" data-selected="true"
											data-value="">
											<option value="_none" selected="selected">——选择测评——</option>
											<option value="运动发育检测">运动发育检测</option>
											<option value="专业体能测评">专业体能测评</option>
											<option value="专业运动素质监控">专业运动素质监控</option>

										</select> <input class="form-control hidden" placeholder="选择测评"
								...
								<li>
									...
									<div class="col-md-6">
										...
										maxlength="10"	class="form-control required" type="text" value="">
									</div>
								</li>
								<li>
									<div class="col-md-3">
								...
								<li>
									...
									<div class="col-md-6">
										...
										maxlength="11" 	class="form-control required" type="text" value="">
									</div>
								</li>
								<li>
									<div class="col-md-3">
									...
									<div class="col-md-6 yx">
										...
										maxlength="50"	class="form-control" type="text" value="">
									</div>
								</li>
								<li>
									<div class="col-md-3">
									...
									<div class="col-md-6">
										<input id="order_qq" name="order_qq" class="form-control"
										maxlength="15" minlength="6"	type="text" value="">
									</div>
								</li>
								<li>
									<div class="col-md-3">
									...
									<div class="col-md-6">
										<input id="order_wechat" name="order_wechat"
											maxlength="50" class="form-control" minlength="2" type="text" value="">
									</div>
								</li>
								<li>
									<div class="col-md-3">
