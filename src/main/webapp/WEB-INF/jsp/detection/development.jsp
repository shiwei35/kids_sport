	...
	<section class="main-body">
		<div class="container-fluid about-banner-header parallax">
			...
			<div class="container text-center">
				<h1>运动发育检测(3-6岁)</h1>
				<p class="intro">采用美国先进的测评方式，全面了解孩子的运动发育情况。</p>
				<div class="text-center">
					<ul class="nav nav-pills nav-about">
						<li role="presentation" class="active"><a href="javascript:;">运动发育检测(3-6岁)</a></li>
		...
		<div class="container about-content ">
			<h2>运动发育检测(3-6岁)</h2>
			<p>采用美国先进的测评方式，全面了解孩子的运动发育情况。</p>
			<h4>检测项目举例</h4>	
			<p>脚尖站、单脚跳、仰卧起坐、前滚翻、抛接球、踢球、精细动作等。</p>		
		</div>
