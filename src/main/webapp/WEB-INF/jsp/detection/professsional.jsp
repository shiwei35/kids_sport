	...
	<section class="main-body">
		<div class="container-fluid about-banner-header parallax">
			...
			<div class="container text-center">
				<h1>专业体能测评(7-12岁)</h1>
				<p class="intro">最全面的了解孩子发育类型及各项素质表现。</p>
				<div class="text-center">
					<ul class="nav nav-pills nav-about">
						<li role="presentation"><a href="<%=request.getContextPath()%>/course/quality.do">运动发育检测(3-6岁)</a></li>
						<li role="presentation"  class="active"><a href="javascript:;">专业体能测评(7-12岁)</a></li>
						<li role="presentation"><a href="<%=request.getContextPath()%>/course/quality.do">专业运动素质监控(3-12岁)</a></li>
